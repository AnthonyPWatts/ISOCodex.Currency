...
- [ ] If the local machine lacks the .NET 9 runtime but has a newer compatible runtime, `pwsh ./eng/smoke-test-package.ps1 -Version 0.9.0-alpha.15 -UseMajorRollForward`
...
- [ ] Create GitHub release notes for `v0.9.0-alpha.15`.
