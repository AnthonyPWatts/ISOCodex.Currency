...
The NuGet-first `0.1.0-alpha.1` release preparation has been implemented locally. Keep future work scoped to APIs that exist in the checkout unless the task explicitly adds them.
