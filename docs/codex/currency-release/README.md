...
This folder contains roadmap notes for `ISOCodex.Currency`.

The NuGet-first release preparation has been implemented and the package family has reached stable `1.0.x`. Keep future work scoped to APIs that exist in the checkout unless the task explicitly adds them.
...
Release evidence and future release checklists now live in `../../release-gate.md`.
